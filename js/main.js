...
mainApp.config(['$stateProvider', '$urlRouterProvider',function($stateProvider, $urlRouterProvider) {
	$stateProvider.state('milkMan', {
		url : '/milkMan',
		templateUrl : '/Interrupt/online-coding/milkMan.html'
	...
	url:"/waterManagement",
	templateUrl:"/Interrupt/online-coding/waterManagement.html"
}).state('robot',{
	url:"/robot",
	templateUrl:"/Interrupt/online-coding/robot.html"
}).state('hotelTrip',{
	url: "/hotelTrip",
	templateUrl:"/Interrupt/online-coding/hotelTrip.html"
})
}]);
...
mainApp.directive('codeBox', function() {
	return {
		restrict : 'E',
		templateUrl : '/Interrupt/online-coding/codeBox.html'
	};
});
